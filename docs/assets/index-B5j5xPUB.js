 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var N_;function Px(){if(N_)return oe;N_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),S=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),x=Symbol.iterator;function M(z){return z===null||typeof z!="object"?null:(z=x&&z[x]||z["@@iterator"],typeof z=="function"?z:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},w=Object.assign,y={};function g(z,it,Rt){this.props=z,this.context=it,this.refs=y,this.updater=Rt||E}g.prototype.isReactComponent={},g.prototype.setState=function(z,it){if(typeof z!="object"&&typeof z!="function"&&z!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,z,it,"setState")},g.prototype.forceUpdate=function(z){this.updater.enqueueForceUpdate(this,z,"forceUpdate")};function N(){}N.prototype=g.prototype;function L(z,it,Rt){this.props=z,this.context=it,this.refs=y,this.updater=Rt||E}var D=L.prototype=new N;D.constructor=L,w(D,g.prototype),D.isPureReactComponent=!0;var H=Array.isArray;function I(){}var U={H:null,A:null,T:null,S:null},B=Object.prototype.hasOwnProperty;function A(z,it,Rt){var Ot=Rt.ref;return{$$typeof:o,type:z,key:it,ref:Ot!==void 0?Ot:null,props:Rt}}function R(z,it){return A(z.type,it,z.props)}function F(z){return typeof z=="object"&&z!==null&&z.$$typeof===o}function Y(z){var it={"=":"=0",":":"=2"};return"$"+z.replace(/[=:]/g,function(Rt){return it[Rt]})}var $=/\/+/g;function ct(z,it){return typeof z=="object"&&z!==null&&z.key!=null?Y(""+z.key):it.toString(36)}function rt(z){switch(z.status){case"fulfilled":return z.value;case"rejected":throw z.reason;default:switch(typeof z.status=="string"?z.then(I,I):(z.status="pending",z.then(function(it){z.status==="pending"&&(z.status="fulfilled",z.value=it)},function(it){z.status==="pending"&&(z.status="rejected",z.reason=it)})),z.status){case"fulfilled":return z.value;case"rejected":throw z.reason}}throw z}function P(z,it,Rt,Ot,zt){var at=typeof z;(at==="undefined"||at==="boolean")&&(z=null);var ht=!1;if(z===null)ht=!0;else switch(at){case"bigint":case"string":case"number":ht=!0;break;case"object":switch(z.$$typeof){case o:case t:ht=!0;break;case S:return ht=z._init,P(ht(z._payload),it,Rt,Ot,zt)}}if(ht)return zt=zt(z),ht=Ot===""?"."+ct(z,0):Ot,H(zt)?(Rt="",ht!=null&&(Rt=ht.replace($,"$&/")+"/"),P(zt,it,Rt,"",function(Kt){return Kt})):zt!=null&&(F(zt)&&(zt=R(zt,Rt+(zt.key==null||z&&z.key===zt.key?"":(""+zt.key).replace($,"$&/")+"/")+ht)),it.push(zt)),1;ht=0;var Dt=Ot===""?".":Ot+":";if(H(z))for(var Gt=0;Gt<z.length;Gt++)Ot=z[Gt],at=Dt+ct(Ot,Gt),ht+=P(Ot,it,Rt,at,zt);else if(Gt=M(z),typeof Gt=="function")for(z=Gt.call(z),Gt=0;!(Ot=z.next()).done;)Ot=Ot.value,at=Dt+ct(Ot,Gt++),ht+=P(Ot,it,Rt,at,zt);else if(at==="object"){if(typeof z.then=="function")return P(rt(z),it,Rt,Ot,zt);throw it=String(z),Error("Objects are not valid as a React child (found: "+(it==="[object Object]"?"object with keys {"+Object.keys(z).join(", ")+"}":it)+"). If you meant to render a collection of children, use an array instead.")}return ht}function j(z,it,Rt){if(z==null)return z;var Ot=[],zt=0;return P(z,Ot,"","",function(at){return it.call(Rt,at,zt++)}),Ot}function q(z){if(z._status===-1){var it=z._result;it=it(),it.then(function(Rt){(z._status===0||z._status===-1)&&(z._status=1,z._result=Rt)},function(Rt){(z._status===0||z._status===-1)&&(z._status=2,z._result=Rt)}),z._status===-1&&(z._status=0,z._result=it)}if(z._status===1)return z._result.default;throw z._result}var _t=typeof reportError=="function"?reportError:function(z){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var it=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof z=="object"&&z!==null&&typeof z.message=="string"?String(z.message):String(z),error:z});if(!window.dispatchEvent(it))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",z);return}console.error(z)},Et={map:j,forEach:function(z,it,Rt){j(z,function(){it.apply(this,arguments)},Rt)},count:function(z){var it=0;return j(z,function(){it++}),it},toArray:function(z){return j(z,function(it){return it})||[]},only:function(z){if(!F(z))throw Error("React.Children.only expected to receive a single React element child.");return z}};return oe.Activity=_,oe.Children=Et,oe.Component=g,oe.Fragment=i,oe.Profiler=l,oe.PureComponent=L,oe.StrictMode=s,oe.Suspense=m,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=U,oe.__COMPILER_RUNTIME={__proto__:null,c:function(z){return U.H.useMemoCache(z)}},oe.cache=function(z){return function(){return z.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(z,it,Rt){if(z==null)throw Error("The argument must be a React element, but you passed "+z+".");var Ot=w({},z.props),zt=z.key;if(it!=null)for(at in it.key!==void 0&&(zt=""+it.key),it)!B.call(it,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&it.ref===void 0||(Ot[at]=it[at]);var at=arguments.length-2;if(at===1)Ot.children=Rt;else if(1<at){for(var ht=Array(at),Dt=0;Dt<at;Dt++)ht[Dt]=arguments[Dt+2];Ot.children=ht}return A(z.type,zt,Ot)},oe.createContext=function(z){return z={$$typeof:h,_currentValue:z,_currentValue2:z,_threadCount:0,Provider:null,Consumer:null},z.Provider=z,z.Consumer={$$typeof:c,_context:z},z},oe.createElement=function(z,it,Rt){var Ot,zt={},at=null;if(it!=null)for(Ot in it.key!==void 0&&(at=""+it.key),it)B.call(it,Ot)&&Ot!=="key"&&Ot!=="__self"&&Ot!=="__source"&&(zt[Ot]=it[Ot]);var ht=arguments.length-2;if(ht===1)zt.children=Rt;else if(1<ht){for(var Dt=Array(ht),Gt=0;Gt<ht;Gt++)Dt[Gt]=arguments[Gt+2];zt.children=Dt}if(z&&z.defaultProps)for(Ot in ht=z.defaultProps,ht)zt[Ot]===void 0&&(zt[Ot]=ht[Ot]);return A(z,at,zt)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(z){return{$$typeof:d,render:z}},oe.isValidElement=F,oe.lazy=function(z){return{$$typeof:S,_payload:{_status:-1,_result:z},_init:q}},oe.memo=function(z,it){return{$$typeof:p,type:z,compare:it===void 0?null:it}},oe.startTransition=function(z){var it=U.T,Rt={};U.T=Rt;try{var Ot=z(),zt=U.S;zt!==null&&zt(Rt,Ot),typeof Ot=="object"&&Ot!==null&&typeof Ot.then=="function"&&Ot.then(I,_t)}catch(at){_t(at)}finally{it!==null&&Rt.types!==null&&(it.types=Rt.types),U.T=it}},oe.unstable_useCacheRefresh=function(){return U.H.useCacheRefresh()},oe.use=function(z){return U.H.use(z)},oe.useActionState=function(z,it,Rt){return U.H.useActionState(z,it,Rt)},oe.useCallback=function(z,it){return U.H.useCallback(z,it)},oe.useContext=function(z){return U.H.useContext(z)},oe.useDebugValue=function(){},oe.useDeferredValue=function(z,it){return U.H.useDeferredValue(z,it)},oe.useEffect=function(z,it){return U.H.useEffect(z,it)},oe.useEffectEvent=function(z){return U.H.useEffectEvent(z)},oe.useId=function(){return U.H.useId()},oe.useImperativeHandle=function(z,it,Rt){return U.H.useImperativeHandle(z,it,Rt)},oe.useInsertionEffect=function(z,it){return U.H.useInsertionEffect(z,it)},oe.useLayoutEffect=function(z,it){return U.H.useLayoutEffect(z,it)},oe.useMemo=function(z,it){return U.H.useMemo(z,it)},oe.useOptimistic=function(z,it){return U.H.useOptimistic(z,it)},oe.useReducer=function(z,it,Rt){return U.H.useReducer(z,it,Rt)},oe.useRef=function(z){return U.H.useRef(z)},oe.useState=function(z){return U.H.useState(z)},oe.useSyncExternalStore=function(z,it,Rt){return U.H.useSyncExternalStore(z,it,Rt)},oe.useTransition=function(){return U.H.useTransition()},oe.version="19.2.0",oe}var O_;function Dd(){return O_||(O_=1,nh.exports=Px()),nh.exports}var An=Dd(),ih={exports:{}},Ro={},ah={exports:{}},sh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P_;function zx(){return P_||(P_=1,(function(o){function t(P,j){var q=P.length;P.push(j);t:for(;0<q;){var _t=q-1>>>1,Et=P[_t];if(0<l(Et,j))P[_t]=j,P[q]=Et,q=_t;else break t}}function i(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var j=P[0],q=P.pop();if(q!==j){P[0]=q;t:for(var _t=0,Et=P.length,z=Et>>>1;_t<z;){var it=2*(_t+1)-1,Rt=P[it],Ot=it+1,zt=P[Ot];if(0>l(Rt,q))Ot<Et&&0>l(zt,Rt)?(P[_t]=zt,P[Ot]=q,_t=Ot):(P[_t]=Rt,P[it]=q,_t=it);else if(Ot<Et&&0>l(zt,q))P[_t]=zt,P[Ot]=q,_t=Ot;else break t}}return j}function l(P,j){var q=P.sortIndex-j.sortIndex;return q!==0?q:P.id-j.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],S=1,_=null,x=3,M=!1,E=!1,w=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function D(P){for(var j=i(p);j!==null;){if(j.callback===null)s(p);else if(j.startTime<=P)s(p),j.sortIndex=j.expirationTime,t(m,j);else break;j=i(p)}}function H(P){if(w=!1,D(P),!E)if(i(m)!==null)E=!0,I||(I=!0,Y());else{var j=i(p);j!==null&&rt(H,j.startTime-P)}}var I=!1,U=-1,B=5,A=-1;function R(){return y?!0:!(o.unstable_now()-A<B)}function F(){if(y=!1,I){var P=o.unstable_now();A=P;var j=!0;try{t:{E=!1,w&&(w=!1,N(U),U=-1),M=!0;var q=x;try{e:{for(D(P),_=i(m);_!==null&&!(_.expirationTime>P&&R());){var _t=_.callback;if(typeof _t=="function"){_.callback=null,x=_.priorityLevel;var Et=_t(_.expirationTime<=P);if(P=o.unstable_now(),typeof Et=="function"){_.callback=Et,D(P),j=!0;break e}_===i(m)&&s(m),D(P)}else s(m);_=i(m)}if(_!==null)j=!0;else{var z=i(p);z!==null&&rt(H,z.startTime-P),j=!1}}break t}finally{_=null,x=q,M=!1}j=void 0}}finally{j?Y():I=!1}}}var Y;if(typeof L=="function")Y=function(){L(F)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,ct=$.port2;$.port1.onmessage=F,Y=function(){ct.postMessage(null)}}else Y=function(){g(F,0)};function rt(P,j){U=g(function(){P(o.unstable_now())},j)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(P){P.callback=null},o.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<P?Math.floor(1e3/P):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(P){switch(x){case 1:case 2:case 3:var j=3;break;default:j=x}var q=x;x=j;try{return P()}finally{x=q}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(P,j){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var q=x;x=P;try{return j()}finally{x=q}},o.unstable_scheduleCallback=function(P,j,q){var _t=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?_t+q:_t):q=_t,P){case 1:var Et=-1;break;case 2:Et=250;break;case 5:Et=1073741823;break;case 4:Et=1e4;break;default:Et=5e3}return Et=q+Et,P={id:S++,callback:j,priorityLevel:P,startTime:q,expirationTime:Et,sortIndex:-1},q>_t?(P.sortIndex=q,t(p,P),i(m)===null&&P===i(p)&&(w?(N(U),U=-1):w=!0,rt(H,q-_t))):(P.sortIndex=Et,t(m,P),E||M||(E=!0,I||(I=!0,Y()))),P},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(P){var j=x;return function(){var q=x;x=j;try{return P.apply(this,arguments)}finally{x=q}}}})(sh)),sh}var z_;function Ix(){return z_||(z_=1,ah.exports=zx()),ah.exports}var rh={exports:{}},Dn={};/**
 * @license React
...
}`;function B1(o,t,i){let s=new kd;const l=new ie,c=new ie,h=new Qe,d=new sM({depthPacking:py}),m=new rM,p={},S=i.maxTextureSize,_={[Ya]:Yn,[Yn]:Ya,[ca]:ca},x=new vi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ie},radius:{value:4}},vertexShader:z1,fragmentShader:I1}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const E=new ai;E.setAttribute("position",new Pi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new Rn(E,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Y0;let g=this.type;this.render=function(I,U,B){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||I.length===0)return;const A=o.getRenderTarget(),R=o.getActiveCubeFace(),F=o.getActiveMipmapLevel(),Y=o.state;Y.setBlending(fa),Y.buffers.depth.getReversed()===!0?Y.buffers.color.setClear(0,0,0,0):Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const $=g!==la&&this.type===la,ct=g===la&&this.type!==la;for(let rt=0,P=I.length;rt<P;rt++){const j=I[rt],q=j.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;l.copy(q.mapSize);const _t=q.getFrameExtents();if(l.multiply(_t),c.copy(q.mapSize),(l.x>S||l.y>S)&&(l.x>S&&(c.x=Math.floor(S/_t.x),l.x=c.x*_t.x,q.mapSize.x=c.x),l.y>S&&(c.y=Math.floor(S/_t.y),l.y=c.y*_t.y,q.mapSize.y=c.y)),q.map===null||$===!0||ct===!0){const z=this.type!==la?{minFilter:In,magFilter:In}:{};q.map!==null&&q.map.dispose(),q.map=new Ii(l.x,l.y,z),q.map.texture.name=j.name+".shadowMap",q.camera.updateProjectionMatrix()}o.setRenderTarget(q.map),o.clear();const Et=q.getViewportCount();for(let z=0;z<Et;z++){const it=q.getViewport(z);h.set(c.x*it.x,c.y*it.y,c.x*it.z,c.y*it.w),Y.viewport(h),q.updateMatrices(j,z),s=q.getFrustum(),D(U,B,q.camera,j,this.type)}q.isPointLightShadow!==!0&&this.type===la&&N(q,B),q.needsUpdate=!1}g=this.type,y.needsUpdate=!1,o.setRenderTarget(A,R,F)};function N(I,U){const B=t.update(w);x.defines.VSM_SAMPLES!==I.blurSamples&&(x.defines.VSM_SAMPLES=I.blurSamples,M.defines.VSM_SAMPLES=I.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Ii(l.x,l.y)),x.uniforms.shadow_pass.value=I.map.texture,x.uniforms.resolution.value=I.mapSize,x.uniforms.radius.value=I.radius,o.setRenderTarget(I.mapPass),o.clear(),o.renderBufferDirect(U,null,B,x,w,null),M.uniforms.shadow_pass.value=I.mapPass.texture,M.uniforms.resolution.value=I.mapSize,M.uniforms.radius.value=I.radius,o.setRenderTarget(I.map),o.clear(),o.renderBufferDirect(U,null,B,M,w,null)}function L(I,U,B,A){let R=null;const F=B.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(F!==void 0)R=F;else if(R=B.isPointLight===!0?m:d,o.localClippingEnabled&&U.clipShadows===!0&&Array.isArray(U.clippingPlanes)&&U.clippingPlanes.length!==0||U.displacementMap&&U.displacementScale!==0||U.alphaMap&&U.alphaTest>0||U.map&&U.alphaTest>0||U.alphaToCoverage===!0){const Y=R.uuid,$=U.uuid;let ct=p[Y];ct===void 0&&(ct={},p[Y]=ct);let rt=ct[$];rt===void 0&&(rt=R.clone(),ct[$]=rt,U.addEventListener("dispose",H)),R=rt}if(R.visible=U.visible,R.wireframe=U.wireframe,A===la?R.side=U.shadowSide!==null?U.shadowSide:U.side:R.side=U.shadowSide!==null?U.shadowSide:_[U.side],R.alphaMap=U.alphaMap,R.alphaTest=U.alphaToCoverage===!0?.5:U.alphaTest,R.map=U.map,R.clipShadows=U.clipShadows,R.clippingPlanes=U.clippingPlanes,R.clipIntersection=U.clipIntersection,R.displacementMap=U.displacementMap,R.displacementScale=U.displacementScale,R.displacementBias=U.displacementBias,R.wireframeLinewidth=U.wireframeLinewidth,R.linewidth=U.linewidth,B.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const Y=o.properties.get(R);Y.light=B}return R}function D(I,U,B,A,R){if(I.visible===!1)return;if(I.layers.test(U.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&R===la)&&(!I.frustumCulled||s.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,I.matrixWorld);const $=t.update(I),ct=I.material;if(Array.isArray(ct)){const rt=$.groups;for(let P=0,j=rt.length;P<j;P++){const q=rt[P],_t=ct[q.materialIndex];if(_t&&_t.visible){const Et=L(I,_t,A,R);I.onBeforeShadow(o,I,U,B,$,Et,q),o.renderBufferDirect(B,null,$,Et,I,q),I.onAfterShadow(o,I,U,B,$,Et,q)}}}else if(ct.visible){const rt=L(I,ct,A,R);I.onBeforeShadow(o,I,U,B,$,rt,null),o.renderBufferDirect(B,null,$,rt,I,null),I.onAfterShadow(o,I,U,B,$,rt,null)}}const Y=I.children;for(let $=0,ct=Y.length;$<ct;$++)D(Y[$],U,B,A,R)}function H(I){I.target.removeEventListener("dispose",H);for(const B in p){const A=p[B],R=I.target.uuid;R in A&&(A[R].dispose(),delete A[R])}}}const F1={[kh]:Xh,[Wh]:jh,[Yh]:Zh,[wr]:qh,[Xh]:kh,[jh]:Wh,[Zh]:Yh,[qh]:wr};function H1(o,t){function i(){let k=!1;const Ct=new Qe;let wt=null;const Ft=new Qe(0,0,0,0);return{setMask:function(At){wt!==At&&!k&&(o.colorMask(At,At,At,At),wt=At)},setLocked:function(At){k=At},setClear:function(At,St,Xt,re,Ne){Ne===!0&&(At*=re,St*=re,Xt*=re),Ct.set(At,St,Xt,re),Ft.equals(Ct)===!1&&(o.clearColor(At,St,Xt,re),Ft.copy(Ct))},reset:function(){k=!1,wt=null,Ft.set(-1,0,0,0)}}}function s(){let k=!1,Ct=!1,wt=null,Ft=null,At=null;return{setReversed:function(St){if(Ct!==St){const Xt=t.get("EXT_clip_control");St?Xt.clipControlEXT(Xt.LOWER_LEFT_EXT,Xt.ZERO_TO_ONE_EXT):Xt.clipControlEXT(Xt.LOWER_LEFT_EXT,Xt.NEGATIVE_ONE_TO_ONE_EXT),Ct=St;const re=At;At=null,this.setClear(re)}},getReversed:function(){return Ct},setTest:function(St){St?ht(o.DEPTH_TEST):Dt(o.DEPTH_TEST)},setMask:function(St){wt!==St&&!k&&(o.depthMask(St),wt=St)},setFunc:function(St){if(Ct&&(St=F1[St]),Ft!==St){switch(St){case kh:o.depthFunc(o.NEVER);break;case Xh:o.depthFunc(o.ALWAYS);break;case Wh:o.depthFunc(o.LESS);break;case wr:o.depthFunc(o.LEQUAL);break;case Yh:o.depthFunc(o.EQUAL);break;case qh:o.depthFunc(o.GEQUAL);break;case jh:o.depthFunc(o.GREATER);break;case Zh:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Ft=St}},setLocked:function(St){k=St},setClear:function(St){At!==St&&(Ct&&(St=1-St),o.clearDepth(St),At=St)},reset:function(){k=!1,wt=null,Ft=null,At=null,Ct=!1}}}function l(){let k=!1,Ct=null,wt=null,Ft=null,At=null,St=null,Xt=null,re=null,Ne=null;return{setTest:function(Ee){k||(Ee?ht(o.STENCIL_TEST):Dt(o.STENCIL_TEST))},setMask:function(Ee){Ct!==Ee&&!k&&(o.stencilMask(Ee),Ct=Ee)},setFunc:function(Ee,Nn,si){(wt!==Ee||Ft!==Nn||At!==si)&&(o.stencilFunc(Ee,Nn,si),wt=Ee,Ft=Nn,At=si)},setOp:function(Ee,Nn,si){(St!==Ee||Xt!==Nn||re!==si)&&(o.stencilOp(Ee,Nn,si),St=Ee,Xt=Nn,re=si)},setLocked:function(Ee){k=Ee},setClear:function(Ee){Ne!==Ee&&(o.clearStencil(Ee),Ne=Ee)},reset:function(){k=!1,Ct=null,wt=null,Ft=null,At=null,St=null,Xt=null,re=null,Ne=null}}}const c=new i,h=new s,d=new l,m=new WeakMap,p=new WeakMap;let S={},_={},x=new WeakMap,M=[],E=null,w=!1,y=null,g=null,N=null,L=null,D=null,H=null,I=null,U=new be(0,0,0),B=0,A=!1,R=null,F=null,Y=null,$=null,ct=null;const rt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let P=!1,j=0;const q=o.getParameter(o.VERSION);q.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(q)[1]),P=j>=1):q.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),P=j>=2);let _t=null,Et={};const z=o.getParameter(o.SCISSOR_BOX),it=o.getParameter(o.VIEWPORT),Rt=new Qe().fromArray(z),Ot=new Qe().fromArray(it);function zt(k,Ct,wt,Ft){const At=new Uint8Array(4),St=o.createTexture();o.bindTexture(k,St),o.texParameteri(k,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(k,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Xt=0;Xt<wt;Xt++)k===o.TEXTURE_3D||k===o.TEXTURE_2D_ARRAY?o.texImage3D(Ct,0,o.RGBA,1,1,Ft,0,o.RGBA,o.UNSIGNED_BYTE,At):o.texImage2D(Ct+Xt,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,At);return St}const at={};at[o.TEXTURE_2D]=zt(o.TEXTURE_2D,o.TEXTURE_2D,1),at[o.TEXTURE_CUBE_MAP]=zt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[o.TEXTURE_2D_ARRAY]=zt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),at[o.TEXTURE_3D]=zt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),c.setClear(0,0,0,1),h.setClear(1),d.setClear(0),ht(o.DEPTH_TEST),h.setFunc(wr),te(!1),kt(G_),ht(o.CULL_FACE),Me(fa);function ht(k){S[k]!==!0&&(o.enable(k),S[k]=!0)}function Dt(k){S[k]!==!1&&(o.disable(k),S[k]=!1)}function Gt(k,Ct){return _[k]!==Ct?(o.bindFramebuffer(k,Ct),_[k]=Ct,k===o.DRAW_FRAMEBUFFER&&(_[o.FRAMEBUFFER]=Ct),k===o.FRAMEBUFFER&&(_[o.DRAW_FRAMEBUFFER]=Ct),!0):!1}function Kt(k,Ct){let wt=M,Ft=!1;if(k){wt=x.get(Ct),wt===void 0&&(wt=[],x.set(Ct,wt));const At=k.textures;if(wt.length!==At.length||wt[0]!==o.COLOR_ATTACHMENT0){for(let St=0,Xt=At.length;St<Xt;St++)wt[St]=o.COLOR_ATTACHMENT0+St;wt.length=At.length,Ft=!0}}else wt[0]!==o.BACK&&(wt[0]=o.BACK,Ft=!0);Ft&&o.drawBuffers(wt)}function le(k){return E!==k?(o.useProgram(k),E=k,!0):!1}const Ke={[xs]:o.FUNC_ADD,[qx]:o.FUNC_SUBTRACT,[jx]:o.FUNC_REVERSE_SUBTRACT};Ke[Zx]=o.MIN,Ke[Kx]=o.MAX;const V={[Qx]:o.ZERO,[Jx]:o.ONE,[$x]:o.SRC_COLOR,[Gh]:o.SRC_ALPHA,[sy]:o.SRC_ALPHA_SATURATE,[iy]:o.DST_COLOR,[ey]:o.DST_ALPHA,[ty]:o.ONE_MINUS_SRC_COLOR,[Vh]:o.ONE_MINUS_SRC_ALPHA,[ay]:o.ONE_MINUS_DST_COLOR,[ny]:o.ONE_MINUS_DST_ALPHA,[ry]:o.CONSTANT_COLOR,[oy]:o.ONE_MINUS_CONSTANT_COLOR,[ly]:o.CONSTANT_ALPHA,[cy]:o.ONE_MINUS_CONSTANT_ALPHA};function Me(k,Ct,wt,Ft,At,St,Xt,re,Ne,Ee){if(k===fa){w===!0&&(Dt(o.BLEND),w=!1);return}if(w===!1&&(ht(o.BLEND),w=!0),k!==Yx){if(k!==y||Ee!==A){if((g!==xs||D!==xs)&&(o.blendEquation(o.FUNC_ADD),g=xs,D=xs),Ee)switch(k){case Rr:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case V_:o.blendFunc(o.ONE,o.ONE);break;case k_:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case X_:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}else switch(k){case Rr:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case V_:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case k_:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case X_:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}N=null,L=null,H=null,I=null,U.set(0,0,0),B=0,y=k,A=Ee}return}At=At||Ct,St=St||wt,Xt=Xt||Ft,(Ct!==g||At!==D)&&(o.blendEquationSeparate(Ke[Ct],Ke[At]),g=Ct,D=At),(wt!==N||Ft!==L||St!==H||Xt!==I)&&(o.blendFuncSeparate(V[wt],V[Ft],V[St],V[Xt]),N=wt,L=Ft,H=St,I=Xt),(re.equals(U)===!1||Ne!==B)&&(o.blendColor(re.r,re.g,re.b,Ne),U.copy(re),B=Ne),y=k,A=!1}function Vt(k,Ct){k.side===ca?Dt(o.CULL_FACE):ht(o.CULL_FACE);let wt=k.side===Yn;Ct&&(wt=!wt),te(wt),k.blending===Rr&&k.transparent===!1?Me(fa):Me(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),h.setFunc(k.depthFunc),h.setTest(k.depthTest),h.setMask(k.depthWrite),c.setMask(k.colorWrite);const Ft=k.stencilWrite;d.setTest(Ft),Ft&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),Wt(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?ht(o.SAMPLE_ALPHA_TO_COVERAGE):Dt(o.SAMPLE_ALPHA_TO_COVERAGE)}function te(k){R!==k&&(k?o.frontFace(o.CW):o.frontFace(o.CCW),R=k)}function kt(k){k!==kx?(ht(o.CULL_FACE),k!==F&&(k===G_?o.cullFace(o.BACK):k===Xx?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Dt(o.CULL_FACE),F=k}function we(k){k!==Y&&(P&&o.lineWidth(k),Y=k)}function Wt(k,Ct,wt){k?(ht(o.POLYGON_OFFSET_FILL),($!==Ct||ct!==wt)&&(o.polygonOffset(Ct,wt),$=Ct,ct=wt)):Dt(o.POLYGON_OFFSET_FILL)}function se(k){k?ht(o.SCISSOR_TEST):Dt(o.SCISSOR_TEST)}function We(k){k===void 0&&(k=o.TEXTURE0+rt-1),_t!==k&&(o.activeTexture(k),_t=k)}function Ye(k,Ct,wt){wt===void 0&&(_t===null?wt=o.TEXTURE0+rt-1:wt=_t);let Ft=Et[wt];Ft===void 0&&(Ft={type:void 0,texture:void 0},Et[wt]=Ft),(Ft.type!==k||Ft.texture!==Ct)&&(_t!==wt&&(o.activeTexture(wt),_t=wt),o.bindTexture(k,Ct||at[k]),Ft.type=k,Ft.texture=Ct)}function O(){const k=Et[_t];k!==void 0&&k.type!==void 0&&(o.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function T(){try{o.compressedTexImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function J(){try{o.compressedTexImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function pt(){try{o.texSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Tt(){try{o.texSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ft(){try{o.compressedTexSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Nt(){try{o.compressedTexSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function mt(){try{o.texStorage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Ut(){try{o.texStorage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Mt(){try{o.texImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ut(){try{o.texImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function xt(k){Rt.equals(k)===!1&&(o.scissor(k.x,k.y,k.z,k.w),Rt.copy(k))}function Pt(k){Ot.equals(k)===!1&&(o.viewport(k.x,k.y,k.z,k.w),Ot.copy(k))}function Lt(k,Ct){let wt=p.get(Ct);wt===void 0&&(wt=new WeakMap,p.set(Ct,wt));let Ft=wt.get(k);Ft===void 0&&(Ft=o.getUniformBlockIndex(Ct,k.name),wt.set(k,Ft))}function bt(k,Ct){const Ft=p.get(Ct).get(k);m.get(Ct)!==Ft&&(o.uniformBlockBinding(Ct,Ft,k.__bindingPointIndex),m.set(Ct,Ft))}function qt(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),h.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),S={},_t=null,Et={},_={},x=new WeakMap,M=[],E=null,w=!1,y=null,g=null,N=null,L=null,D=null,H=null,I=null,U=new be(0,0,0),B=0,A=!1,R=null,F=null,Y=null,$=null,ct=null,Rt.set(0,0,o.canvas.width,o.canvas.height),Ot.set(0,0,o.canvas.width,o.canvas.height),c.reset(),h.reset(),d.reset()}return{buffers:{color:c,depth:h,stencil:d},enable:ht,disable:Dt,bindFramebuffer:Gt,drawBuffers:Kt,useProgram:le,setBlending:Me,setMaterial:Vt,setFlipSided:te,setCullFace:kt,setLineWidth:we,setPolygonOffset:Wt,setScissorTest:se,activeTexture:We,bindTexture:Ye,unbindTexture:O,compressedTexImage2D:T,compressedTexImage3D:J,texImage2D:Mt,texImage3D:ut,updateUBOMapping:Lt,uniformBlockBinding:bt,texStorage2D:mt,texStorage3D:Ut,texSubImage2D:pt,texSubImage3D:Tt,compressedTexSubImage2D:ft,compressedTexSubImage3D:Nt,scissor:xt,viewport:Pt,reset:qt}}function G1(o,t,i,s,l,c,h){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new ie,S=new WeakMap;let _;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(O,T){return M?new OffscreenCanvas(O,T):Gc("canvas")}function w(O,T,J){let pt=1;const Tt=Ye(O);if((Tt.width>J||Tt.height>J)&&(pt=J/Math.max(Tt.width,Tt.height)),pt<1)if(typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&O instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&O instanceof ImageBitmap||typeof VideoFrame<"u"&&O instanceof VideoFrame){const ft=Math.floor(pt*Tt.width),Nt=Math.floor(pt*Tt.height);_===void 0&&(_=E(ft,Nt));const mt=T?E(ft,Nt):_;return mt.width=ft,mt.height=Nt,mt.getContext("2d").drawImage(O,0,0,ft,Nt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Tt.width+"x"+Tt.height+") to ("+ft+"x"+Nt+")."),mt}else return"data"in O&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Tt.width+"x"+Tt.height+")."),O;return O}function y(O){return O.generateMipmaps}function g(O){o.generateMipmap(O)}function N(O){return O.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:O.isWebGL3DRenderTarget?o.TEXTURE_3D:O.isWebGLArrayRenderTarget||O.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(O,T,J,pt,Tt=!1){if(O!==null){if(o[O]!==void 0)return o[O];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+O+"'")}let ft=T;if(T===o.RED&&(J===o.FLOAT&&(ft=o.R32F),J===o.HALF_FLOAT&&(ft=o.R16F),J===o.UNSIGNED_BYTE&&(ft=o.R8)),T===o.RED_INTEGER&&(J===o.UNSIGNED_BYTE&&(ft=o.R8UI),J===o.UNSIGNED_SHORT&&(ft=o.R16UI),J===o.UNSIGNED_INT&&(ft=o.R32UI),J===o.BYTE&&(ft=o.R8I),J===o.SHORT&&(ft=o.R16I),J===o.INT&&(ft=o.R32I)),T===o.RG&&(J===o.FLOAT&&(ft=o.RG32F),J===o.HALF_FLOAT&&(ft=o.RG16F),J===o.UNSIGNED_BYTE&&(ft=o.RG8)),T===o.RG_INTEGER&&(J===o.UNSIGNED_BYTE&&(ft=o.RG8UI),J===o.UNSIGNED_SHORT&&(ft=o.RG16UI),J===o.UNSIGNED_INT&&(ft=o.RG32UI),J===o.BYTE&&(ft=o.RG8I),J===o.SHORT&&(ft=o.RG16I),J===o.INT&&(ft=o.RG32I)),T===o.RGB_INTEGER&&(J===o.UNSIGNED_BYTE&&(ft=o.RGB8UI),J===o.UNSIGNED_SHORT&&(ft=o.RGB16UI),J===o.UNSIGNED_INT&&(ft=o.RGB32UI),J===o.BYTE&&(ft=o.RGB8I),J===o.SHORT&&(ft=o.RGB16I),J===o.INT&&(ft=o.RGB32I)),T===o.RGBA_INTEGER&&(J===o.UNSIGNED_BYTE&&(ft=o.RGBA8UI),J===o.UNSIGNED_SHORT&&(ft=o.RGBA16UI),J===o.UNSIGNED_INT&&(ft=o.RGBA32UI),J===o.BYTE&&(ft=o.RGBA8I),J===o.SHORT&&(ft=o.RGBA16I),J===o.INT&&(ft=o.RGBA32I)),T===o.RGB&&(J===o.UNSIGNED_INT_5_9_9_9_REV&&(ft=o.RGB9_E5),J===o.UNSIGNED_INT_10F_11F_11F_REV&&(ft=o.R11F_G11F_B10F)),T===o.RGBA){const Nt=Tt?Fc:Ae.getTransfer(pt);J===o.FLOAT&&(ft=o.RGBA32F),J===o.HALF_FLOAT&&(ft=o.RGBA16F),J===o.UNSIGNED_BYTE&&(ft=Nt===ze?o.SRGB8_ALPHA8:o.RGBA8),J===o.UNSIGNED_SHORT_4_4_4_4&&(ft=o.RGBA4),J===o.UNSIGNED_SHORT_5_5_5_1&&(ft=o.RGB5_A1)}return(ft===o.R16F||ft===o.R32F||ft===o.RG16F||ft===o.RG32F||ft===o.RGBA16F||ft===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ft}function D(O,T){let J;return O?T===null||T===Ts||T===Ho?J=o.DEPTH24_STENCIL8:T===ua?J=o.DEPTH32F_STENCIL8:T===Fo&&(J=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Ts||T===Ho?J=o.DEPTH_COMPONENT24:T===ua?J=o.DEPTH_COMPONENT32F:T===Fo&&(J=o.DEPTH_COMPONENT16),J}function H(O,T){return y(O)===!0||O.isFramebufferTexture&&O.minFilter!==In&&O.minFilter!==Ni?Math.log2(Math.max(T.width,T.height))+1:O.mipmaps!==void 0&&O.mipmaps.length>0?O.mipmaps.length:O.isCompressedTexture&&Array.isArray(O.image)?T.mipmaps.length:1}function I(O){const T=O.target;T.removeEventListener("dispose",I),B(T),T.isVideoTexture&&S.delete(T)}function U(O){const T=O.target;T.removeEventListener("dispose",U),R(T)}function B(O){const T=s.get(O);if(T.__webglInit===void 0)return;const J=O.source,pt=x.get(J);if(pt){const Tt=pt[T.__cacheKey];Tt.usedTimes--,Tt.usedTimes===0&&A(O),Object.keys(pt).length===0&&x.delete(J)}s.remove(O)}function A(O){const T=s.get(O);o.deleteTexture(T.__webglTexture);const J=O.source,pt=x.get(J);delete pt[T.__cacheKey],h.memory.textures--}function R(O){const T=s.get(O);if(O.depthTexture&&(O.depthTexture.dispose(),s.remove(O.depthTexture)),O.isWebGLCubeRenderTarget)for(let pt=0;pt<6;pt++){if(Array.isArray(T.__webglFramebuffer[pt]))for(let Tt=0;Tt<T.__webglFramebuffer[pt].length;Tt++)o.deleteFramebuffer(T.__webglFramebuffer[pt][Tt]);else o.deleteFramebuffer(T.__webglFramebuffer[pt]);T.__webglDepthbuffer&&o.deleteRenderbuffer(T.__webglDepthbuffer[pt])}else{if(Array.isArray(T.__webglFramebuffer))for(let pt=0;pt<T.__webglFramebuffer.length;pt++)o.deleteFramebuffer(T.__webglFramebuffer[pt]);else o.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&o.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&o.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let pt=0;pt<T.__webglColorRenderbuffer.length;pt++)T.__webglColorRenderbuffer[pt]&&o.deleteRenderbuffer(T.__webglColorRenderbuffer[pt]);T.__webglDepthRenderbuffer&&o.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const J=O.textures;for(let pt=0,Tt=J.length;pt<Tt;pt++){const ft=s.get(J[pt]);ft.__webglTexture&&(o.deleteTexture(ft.__webglTexture),h.memory.textures--),s.remove(J[pt])}s.remove(O)}let F=0;function Y(){F=0}function $(){const O=F;return O>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+O+" texture units while this GPU supports only "+l.maxTextures),F+=1,O}function ct(O){const T=[];return T.push(O.wrapS),T.push(O.wrapT),T.push(O.wrapR||0),T.push(O.magFilter),T.push(O.minFilter),T.push(O.anisotropy),T.push(O.internalFormat),T.push(O.format),T.push(O.type),T.push(O.generateMipmaps),T.push(O.premultiplyAlpha),T.push(O.flipY),T.push(O.unpackAlignment),T.push(O.colorSpace),T.join()}function rt(O,T){const J=s.get(O);if(O.isVideoTexture&&se(O),O.isRenderTargetTexture===!1&&O.isExternalTexture!==!0&&O.version>0&&J.__version!==O.version){const pt=O.image;if(pt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{at(J,O,T);return}}else O.isExternalTexture&&(J.__webglTexture=O.sourceTexture?O.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,J.__webglTexture,o.TEXTURE0+T)}function P(O,T){const J=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&J.__version!==O.version){at(J,O,T);return}i.bindTexture(o.TEXTURE_2D_ARRAY,J.__webglTexture,o.TEXTURE0+T)}function j(O,T){const J=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&J.__version!==O.version){at(J,O,T);return}i.bindTexture(o.TEXTURE_3D,J.__webglTexture,o.TEXTURE0+T)}function q(O,T){const J=s.get(O);if(O.version>0&&J.__version!==O.version){ht(J,O,T);return}i.bindTexture(o.TEXTURE_CUBE_MAP,J.__webglTexture,o.TEXTURE0+T)}const _t={[Jh]:o.REPEAT,[Ms]:o.CLAMP_TO_EDGE,[$h]:o.MIRRORED_REPEAT},Et={[In]:o.NEAREST,[hy]:o.NEAREST_MIPMAP_NEAREST,[ac]:o.NEAREST_MIPMAP_LINEAR,[Ni]:o.LINEAR,[oh]:o.LINEAR_MIPMAP_NEAREST,[Es]:o.LINEAR_MIPMAP_LINEAR},z={[gy]:o.NEVER,[My]:o.ALWAYS,[_y]:o.LESS,[cv]:o.LEQUAL,[vy]:o.EQUAL,[yy]:o.GEQUAL,[Sy]:o.GREATER,[xy]:o.NOTEQUAL};function it(O,T){if(T.type===ua&&t.has("OES_texture_float_linear")===!1&&(T.magFilter===Ni||T.magFilter===oh||T.magFilter===ac||T.magFilter===Es||T.minFilter===Ni||T.minFilter===oh||T.minFilter===ac||T.minFilter===Es)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(O,o.TEXTURE_WRAP_S,_t[T.wrapS]),o.texParameteri(O,o.TEXTURE_WRAP_T,_t[T.wrapT]),(O===o.TEXTURE_3D||O===o.TEXTURE_2D_ARRAY)&&o.texParameteri(O,o.TEXTURE_WRAP_R,_t[T.wrapR]),o.texParameteri(O,o.TEXTURE_MAG_FILTER,Et[T.magFilter]),o.texParameteri(O,o.TEXTURE_MIN_FILTER,Et[T.minFilter]),T.compareFunction&&(o.texParameteri(O,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(O,o.TEXTURE_COMPARE_FUNC,z[T.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===In||T.minFilter!==ac&&T.minFilter!==Es||T.type===ua&&t.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||s.get(T).__currentAnisotropy){const J=t.get("EXT_texture_filter_anisotropic");o.texParameterf(O,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,l.getMaxAnisotropy())),s.get(T).__currentAnisotropy=T.anisotropy}}}function Rt(O,T){let J=!1;O.__webglInit===void 0&&(O.__webglInit=!0,T.addEventListener("dispose",I));const pt=T.source;let Tt=x.get(pt);Tt===void 0&&(Tt={},x.set(pt,Tt));const ft=ct(T);if(ft!==O.__cacheKey){Tt[ft]===void 0&&(Tt[ft]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,J=!0),Tt[ft].usedTimes++;const Nt=Tt[O.__cacheKey];Nt!==void 0&&(Tt[O.__cacheKey].usedTimes--,Nt.usedTimes===0&&A(T)),O.__cacheKey=ft,O.__webglTexture=Tt[ft].texture}return J}function Ot(O,T,J){return Math.floor(Math.floor(O/J)/T)}function zt(O,T,J,pt){const ft=O.updateRanges;if(ft.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,T.width,T.height,J,pt,T.data);else{ft.sort((ut,xt)=>ut.start-xt.start);let Nt=0;for(let ut=1;ut<ft.length;ut++){const xt=ft[Nt],Pt=ft[ut],Lt=xt.start+xt.count,bt=Ot(Pt.start,T.width,4),qt=Ot(xt.start,T.width,4);Pt.start<=Lt+1&&bt===qt&&Ot(Pt.start+Pt.count-1,T.width,4)===bt?xt.count=Math.max(xt.count,Pt.start+Pt.count-xt.start):(++Nt,ft[Nt]=Pt)}ft.length=Nt+1;const mt=o.getParameter(o.UNPACK_ROW_LENGTH),Ut=o.getParameter(o.UNPACK_SKIP_PIXELS),Mt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,T.width);for(let ut=0,xt=ft.length;ut<xt;ut++){const Pt=ft[ut],Lt=Math.floor(Pt.start/4),bt=Math.ceil(Pt.count/4),qt=Lt%T.width,k=Math.floor(Lt/T.width),Ct=bt,wt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,qt),o.pixelStorei(o.UNPACK_SKIP_ROWS,k),i.texSubImage2D(o.TEXTURE_2D,0,qt,k,Ct,wt,J,pt,T.data)}O.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,mt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Ut),o.pixelStorei(o.UNPACK_SKIP_ROWS,Mt)}}function at(O,T,J){let pt=o.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(pt=o.TEXTURE_2D_ARRAY),T.isData3DTexture&&(pt=o.TEXTURE_3D);const Tt=Rt(O,T),ft=T.source;i.bindTexture(pt,O.__webglTexture,o.TEXTURE0+J);const Nt=s.get(ft);if(ft.version!==Nt.__version||Tt===!0){i.activeTexture(o.TEXTURE0+J);const mt=Ae.getPrimaries(Ae.workingColorSpace),Ut=T.colorSpace===Xa?null:Ae.getPrimaries(T.colorSpace),Mt=T.colorSpace===Xa||mt===Ut?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,T.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,T.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);let ut=w(T.image,!1,l.maxTextureSize);ut=We(T,ut);const xt=c.convert(T.format,T.colorSpace),Pt=c.convert(T.type);let Lt=L(T.internalFormat,xt,Pt,T.colorSpace,T.isVideoTexture);it(pt,T);let bt;const qt=T.mipmaps,k=T.isVideoTexture!==!0,Ct=Nt.__version===void 0||Tt===!0,wt=ft.dataReady,Ft=H(T,ut);if(T.isDepthTexture)Lt=D(T.format===Vo,T.type),Ct&&(k?i.texStorage2D(o.TEXTURE_2D,1,Lt,ut.width,ut.height):i.texImage2D(o.TEXTURE_2D,0,Lt,ut.width,ut.height,0,xt,Pt,null));else if(T.isDataTexture)if(qt.length>0){k&&Ct&&i.texStorage2D(o.TEXTURE_2D,Ft,Lt,qt[0].width,qt[0].height);for(let At=0,St=qt.length;At<St;At++)bt=qt[At],k?wt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,bt.width,bt.height,xt,Pt,bt.data):i.texImage2D(o.TEXTURE_2D,At,Lt,bt.width,bt.height,0,xt,Pt,bt.data);T.generateMipmaps=!1}else k?(Ct&&i.texStorage2D(o.TEXTURE_2D,Ft,Lt,ut.width,ut.height),wt&&zt(T,ut,xt,Pt)):i.texImage2D(o.TEXTURE_2D,0,Lt,ut.width,ut.height,0,xt,Pt,ut.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){k&&Ct&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ft,Lt,qt[0].width,qt[0].height,ut.depth);for(let At=0,St=qt.length;At<St;At++)if(bt=qt[At],T.format!==bi)if(xt!==null)if(k){if(wt)if(T.layerUpdates.size>0){const Xt=v0(bt.width,bt.height,T.format,T.type);for(const re of T.layerUpdates){const Ne=bt.data.subarray(re*Xt/bt.data.BYTES_PER_ELEMENT,(re+1)*Xt/bt.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,re,bt.width,bt.height,1,xt,Ne)}T.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,bt.width,bt.height,ut.depth,xt,bt.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,At,Lt,bt.width,bt.height,ut.depth,0,bt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?wt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,bt.width,bt.height,ut.depth,xt,Pt,bt.data):i.texImage3D(o.TEXTURE_2D_ARRAY,At,Lt,bt.width,bt.height,ut.depth,0,xt,Pt,bt.data)}else{k&&Ct&&i.texStorage2D(o.TEXTURE_2D,Ft,Lt,qt[0].width,qt[0].height);for(let At=0,St=qt.length;At<St;At++)bt=qt[At],T.format!==bi?xt!==null?k?wt&&i.compressedTexSubImage2D(o.TEXTURE_2D,At,0,0,bt.width,bt.height,xt,bt.data):i.compressedTexImage2D(o.TEXTURE_2D,At,Lt,bt.width,bt.height,0,bt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?wt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,bt.width,bt.height,xt,Pt,bt.data):i.texImage2D(o.TEXTURE_2D,At,Lt,bt.width,bt.height,0,xt,Pt,bt.data)}else if(T.isDataArrayTexture)if(k){if(Ct&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ft,Lt,ut.width,ut.height,ut.depth),wt)if(T.layerUpdates.size>0){const At=v0(ut.width,ut.height,T.format,T.type);for(const St of T.layerUpdates){const Xt=ut.data.subarray(St*At/ut.data.BYTES_PER_ELEMENT,(St+1)*At/ut.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,St,ut.width,ut.height,1,xt,Pt,Xt)}T.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,ut.width,ut.height,ut.depth,xt,Pt,ut.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Lt,ut.width,ut.height,ut.depth,0,xt,Pt,ut.data);else if(T.isData3DTexture)k?(Ct&&i.texStorage3D(o.TEXTURE_3D,Ft,Lt,ut.width,ut.height,ut.depth),wt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,ut.width,ut.height,ut.depth,xt,Pt,ut.data)):i.texImage3D(o.TEXTURE_3D,0,Lt,ut.width,ut.height,ut.depth,0,xt,Pt,ut.data);else if(T.isFramebufferTexture){if(Ct)if(k)i.texStorage2D(o.TEXTURE_2D,Ft,Lt,ut.width,ut.height);else{let At=ut.width,St=ut.height;for(let Xt=0;Xt<Ft;Xt++)i.texImage2D(o.TEXTURE_2D,Xt,Lt,At,St,0,xt,Pt,null),At>>=1,St>>=1}}else if(qt.length>0){if(k&&Ct){const At=Ye(qt[0]);i.texStorage2D(o.TEXTURE_2D,Ft,Lt,At.width,At.height)}for(let At=0,St=qt.length;At<St;At++)bt=qt[At],k?wt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,xt,Pt,bt):i.texImage2D(o.TEXTURE_2D,At,Lt,xt,Pt,bt);T.generateMipmaps=!1}else if(k){if(Ct){const At=Ye(ut);i.texStorage2D(o.TEXTURE_2D,Ft,Lt,At.width,At.height)}wt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,xt,Pt,ut)}else i.texImage2D(o.TEXTURE_2D,0,Lt,xt,Pt,ut);y(T)&&g(pt),Nt.__version=ft.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function ht(O,T,J){if(T.image.length!==6)return;const pt=Rt(O,T),Tt=T.source;i.bindTexture(o.TEXTURE_CUBE_MAP,O.__webglTexture,o.TEXTURE0+J);const ft=s.get(Tt);if(Tt.version!==ft.__version||pt===!0){i.activeTexture(o.TEXTURE0+J);const Nt=Ae.getPrimaries(Ae.workingColorSpace),mt=T.colorSpace===Xa?null:Ae.getPrimaries(T.colorSpace),Ut=T.colorSpace===Xa||Nt===mt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,T.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,T.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);const Mt=T.isCompressedTexture||T.image[0].isCompressedTexture,ut=T.image[0]&&T.image[0].isDataTexture,xt=[];for(let St=0;St<6;St++)!Mt&&!ut?xt[St]=w(T.image[St],!0,l.maxCubemapSize):xt[St]=ut?T.image[St].image:T.image[St],xt[St]=We(T,xt[St]);const Pt=xt[0],Lt=c.convert(T.format,T.colorSpace),bt=c.convert(T.type),qt=L(T.internalFormat,Lt,bt,T.colorSpace),k=T.isVideoTexture!==!0,Ct=ft.__version===void 0||pt===!0,wt=Tt.dataReady;let Ft=H(T,Pt);it(o.TEXTURE_CUBE_MAP,T);let At;if(Mt){k&&Ct&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Ft,qt,Pt.width,Pt.height);for(let St=0;St<6;St++){At=xt[St].mipmaps;for(let Xt=0;Xt<At.length;Xt++){const re=At[Xt];T.format!==bi?Lt!==null?k?wt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt,0,0,re.width,re.height,Lt,re.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt,qt,re.width,re.height,0,re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?wt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt,0,0,re.width,re.height,Lt,bt,re.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt,qt,re.width,re.height,0,Lt,bt,re.data)}}}else{if(At=T.mipmaps,k&&Ct){At.length>0&&Ft++;const St=Ye(xt[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Ft,qt,St.width,St.height)}for(let St=0;St<6;St++)if(ut){k?wt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,0,0,xt[St].width,xt[St].height,Lt,bt,xt[St].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,qt,xt[St].width,xt[St].height,0,Lt,bt,xt[St].data);for(let Xt=0;Xt<At.length;Xt++){const Ne=At[Xt].image[St].image;k?wt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt+1,0,0,Ne.width,Ne.height,Lt,bt,Ne.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt+1,qt,Ne.width,Ne.height,0,Lt,bt,Ne.data)}}else{k?wt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,0,0,Lt,bt,xt[St]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,qt,Lt,bt,xt[St]);for(let Xt=0;Xt<At.length;Xt++){const re=At[Xt];k?wt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt+1,0,0,Lt,bt,re.image[St]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+St,Xt+1,qt,Lt,bt,re.image[St])}}}y(T)&&g(o.TEXTURE_CUBE_MAP),ft.__version=Tt.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function Dt(O,T,J,pt,Tt,ft){const Nt=c.convert(J.format,J.colorSpace),mt=c.convert(J.type),Ut=L(J.internalFormat,Nt,mt,J.colorSpace),Mt=s.get(T),ut=s.get(J);if(ut.__renderTarget=T,!Mt.__hasExternalTextures){const xt=Math.max(1,T.width>>ft),Pt=Math.max(1,T.height>>ft);Tt===o.TEXTURE_3D||Tt===o.TEXTURE_2D_ARRAY?i.texImage3D(Tt,ft,Ut,xt,Pt,T.depth,0,Nt,mt,null):i.texImage2D(Tt,ft,Ut,xt,Pt,0,Nt,mt,null)}i.bindFramebuffer(o.FRAMEBUFFER,O),Wt(T)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,pt,Tt,ut.__webglTexture,0,we(T)):(Tt===o.TEXTURE_2D||Tt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&Tt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,pt,Tt,ut.__webglTexture,ft),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Gt(O,T,J){if(o.bindRenderbuffer(o.RENDERBUFFER,O),T.depthBuffer){const pt=T.depthTexture,Tt=pt&&pt.isDepthTexture?pt.type:null,ft=D(T.stencilBuffer,Tt),Nt=T.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,mt=we(T);Wt(T)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,mt,ft,T.width,T.height):J?o.renderbufferStorageMultisample(o.RENDERBUFFER,mt,ft,T.width,T.height):o.renderbufferStorage(o.RENDERBUFFER,ft,T.width,T.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Nt,o.RENDERBUFFER,O)}else{const pt=T.textures;for(let Tt=0;Tt<pt.length;Tt++){const ft=pt[Tt],Nt=c.convert(ft.format,ft.colorSpace),mt=c.convert(ft.type),Ut=L(ft.internalFormat,Nt,mt,ft.colorSpace),Mt=we(T);J&&Wt(T)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Mt,Ut,T.width,T.height):Wt(T)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Mt,Ut,T.width,T.height):o.renderbufferStorage(o.RENDERBUFFER,Ut,T.width,T.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Kt(O,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,O),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pt=s.get(T.depthTexture);pt.__renderTarget=T,(!pt.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),rt(T.depthTexture,0);const Tt=pt.__webglTexture,ft=we(T);if(T.depthTexture.format===Go)Wt(T)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Tt,0,ft):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Tt,0);else if(T.depthTexture.format===Vo)Wt(T)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Tt,0,ft):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Tt,0);else throw new Error("Unknown depthTexture format")}function le(O){const T=s.get(O),J=O.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==O.depthTexture){const pt=O.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),pt){const Tt=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,pt.removeEventListener("dispose",Tt)};pt.addEventListener("dispose",Tt),T.__depthDisposeCallback=Tt}T.__boundDepthTexture=pt}if(O.depthTexture&&!T.__autoAllocateDepthBuffer){if(J)throw new Error("target.depthTexture not supported in Cube render targets");const pt=O.texture.mipmaps;pt&&pt.length>0?Kt(T.__webglFramebuffer[0],O):Kt(T.__webglFramebuffer,O)}else if(J){T.__webglDepthbuffer=[];for(let pt=0;pt<6;pt++)if(i.bindFramebuffer(o.FRAMEBUFFER,T.__webglFramebuffer[pt]),T.__webglDepthbuffer[pt]===void 0)T.__webglDepthbuffer[pt]=o.createRenderbuffer(),Gt(T.__webglDepthbuffer[pt],O,!1);else{const Tt=O.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ft=T.__webglDepthbuffer[pt];o.bindRenderbuffer(o.RENDERBUFFER,ft),o.framebufferRenderbuffer(o.FRAMEBUFFER,Tt,o.RENDERBUFFER,ft)}}else{const pt=O.texture.mipmaps;if(pt&&pt.length>0?i.bindFramebuffer(o.FRAMEBUFFER,T.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=o.createRenderbuffer(),Gt(T.__webglDepthbuffer,O,!1);else{const Tt=O.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ft=T.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ft),o.framebufferRenderbuffer(o.FRAMEBUFFER,Tt,o.RENDERBUFFER,ft)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ke(O,T,J){const pt=s.get(O);T!==void 0&&Dt(pt.__webglFramebuffer,O,O.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),J!==void 0&&le(O)}function V(O){const T=O.texture,J=s.get(O),pt=s.get(T);O.addEventListener("dispose",U);const Tt=O.textures,ft=O.isWebGLCubeRenderTarget===!0,Nt=Tt.length>1;if(Nt||(pt.__webglTexture===void 0&&(pt.__webglTexture=o.createTexture()),pt.__version=T.version,h.memory.textures++),ft){J.__webglFramebuffer=[];for(let mt=0;mt<6;mt++)if(T.mipmaps&&T.mipmaps.length>0){J.__webglFramebuffer[mt]=[];for(let Ut=0;Ut<T.mipmaps.length;Ut++)J.__webglFramebuffer[mt][Ut]=o.createFramebuffer()}else J.__webglFramebuffer[mt]=o.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){J.__webglFramebuffer=[];for(let mt=0;mt<T.mipmaps.length;mt++)J.__webglFramebuffer[mt]=o.createFramebuffer()}else J.__webglFramebuffer=o.createFramebuffer();if(Nt)for(let mt=0,Ut=Tt.length;mt<Ut;mt++){const Mt=s.get(Tt[mt]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=o.createTexture(),h.memory.textures++)}if(O.samples>0&&Wt(O)===!1){J.__webglMultisampledFramebuffer=o.createFramebuffer(),J.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let mt=0;mt<Tt.length;mt++){const Ut=Tt[mt];J.__webglColorRenderbuffer[mt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,J.__webglColorRenderbuffer[mt]);const Mt=c.convert(Ut.format,Ut.colorSpace),ut=c.convert(Ut.type),xt=L(Ut.internalFormat,Mt,ut,Ut.colorSpace,O.isXRRenderTarget===!0),Pt=we(O);o.renderbufferStorageMultisample(o.RENDERBUFFER,Pt,xt,O.width,O.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+mt,o.RENDERBUFFER,J.__webglColorRenderbuffer[mt])}o.bindRenderbuffer(o.RENDERBUFFER,null),O.depthBuffer&&(J.__webglDepthRenderbuffer=o.createRenderbuffer(),Gt(J.__webglDepthRenderbuffer,O,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ft){i.bindTexture(o.TEXTURE_CUBE_MAP,pt.__webglTexture),it(o.TEXTURE_CUBE_MAP,T);for(let mt=0;mt<6;mt++)if(T.mipmaps&&T.mipmaps.length>0)for(let Ut=0;Ut<T.mipmaps.length;Ut++)Dt(J.__webglFramebuffer[mt][Ut],O,T,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,Ut);else Dt(J.__webglFramebuffer[mt],O,T,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0);y(T)&&g(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Nt){for(let mt=0,Ut=Tt.length;mt<Ut;mt++){const Mt=Tt[mt],ut=s.get(Mt);let xt=o.TEXTURE_2D;(O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(xt=O.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(xt,ut.__webglTexture),it(xt,Mt),Dt(J.__webglFramebuffer,O,Mt,o.COLOR_ATTACHMENT0+mt,xt,0),y(Mt)&&g(xt)}i.unbindTexture()}else{let mt=o.TEXTURE_2D;if((O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(mt=O.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(mt,pt.__webglTexture),it(mt,T),T.mipmaps&&T.mipmaps.length>0)for(let Ut=0;Ut<T.mipmaps.length;Ut++)Dt(J.__webglFramebuffer[Ut],O,T,o.COLOR_ATTACHMENT0,mt,Ut);else Dt(J.__webglFramebuffer,O,T,o.COLOR_ATTACHMENT0,mt,0);y(T)&&g(mt),i.unbindTexture()}O.depthBuffer&&le(O)}function Me(O){const T=O.textures;for(let J=0,pt=T.length;J<pt;J++){const Tt=T[J];if(y(Tt)){const ft=N(O),Nt=s.get(Tt).__webglTexture;i.bindTexture(ft,Nt),g(ft),i.unbindTexture()}}}const Vt=[],te=[];function kt(O){if(O.samples>0){if(Wt(O)===!1){const T=O.textures,J=O.width,pt=O.height;let Tt=o.COLOR_BUFFER_BIT;const ft=O.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Nt=s.get(O),mt=T.length>1;if(mt)for(let Mt=0;Mt<T.length;Mt++)i.bindFramebuffer(o.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Mt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Nt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Mt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer);const Ut=O.texture.mipmaps;Ut&&Ut.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Nt.__webglFramebuffer);for(let Mt=0;Mt<T.length;Mt++){if(O.resolveDepthBuffer&&(O.depthBuffer&&(Tt|=o.DEPTH_BUFFER_BIT),O.stencilBuffer&&O.resolveStencilBuffer&&(Tt|=o.STENCIL_BUFFER_BIT)),mt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Nt.__webglColorRenderbuffer[Mt]);const ut=s.get(T[Mt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,ut,0)}o.blitFramebuffer(0,0,J,pt,0,0,J,pt,Tt,o.NEAREST),m===!0&&(Vt.length=0,te.length=0,Vt.push(o.COLOR_ATTACHMENT0+Mt),O.depthBuffer&&O.resolveDepthBuffer===!1&&(Vt.push(ft),te.push(ft),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,te)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,Vt))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),mt)for(let Mt=0;Mt<T.length;Mt++){i.bindFramebuffer(o.FRAMEBUFFER,Nt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Mt,o.RENDERBUFFER,Nt.__webglColorRenderbuffer[Mt]);const ut=s.get(T[Mt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Nt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Mt,o.TEXTURE_2D,ut,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Nt.__webglMultisampledFramebuffer)}else if(O.depthBuffer&&O.resolveDepthBuffer===!1&&m){const T=O.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[T])}}}function we(O){return Math.min(l.maxSamples,O.samples)}function Wt(O){const T=s.get(O);return O.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function se(O){const T=h.render.frame;S.get(O)!==T&&(S.set(O,T),O.update())}function We(O,T){const J=O.colorSpace,pt=O.format,Tt=O.type;return O.isCompressedTexture===!0||O.isVideoTexture===!0||J!==Lr&&J!==Xa&&(Ae.getTransfer(J)===ze?(pt!==bi||Tt!==zi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",J)),T}function Ye(O){return typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement?(p.width=O.naturalWidth||O.width,p.height=O.naturalHeight||O.height):typeof VideoFrame<"u"&&O instanceof VideoFrame?(p.width=O.displayWidth,p.height=O.displayHeight):(p.width=O.width,p.height=O.height),p}this.allocateTextureUnit=$,this.resetTextureUnits=Y,this.setTexture2D=rt,this.setTexture2DArray=P,this.setTexture3D=j,this.setTextureCube=q,this.rebindTextures=Ke,this.setupRenderTarget=V,this.updateRenderTargetMipmap=Me,this.updateMultisampleRenderTarget=kt,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=Dt,this.useMultisampledRTT=Wt}function V1(o,t){function i(s,l=Xa){let c;const h=Ae.getTransfer(l);if(s===zi)return o.UNSIGNED_BYTE;if(s===Od)return o.UNSIGNED_SHORT_4_4_4_4;if(s===Pd)return o.UNSIGNED_SHORT_5_5_5_1;if(s===iv)return o.UNSIGNED_INT_5_9_9_9_REV;if(s===av)return o.UNSIGNED_INT_10F_11F_11F_REV;if(s===ev)return o.BYTE;if(s===nv)return o.SHORT;if(s===Fo)return o.UNSIGNED_SHORT;if(s===Nd)return o.INT;if(s===Ts)return o.UNSIGNED_INT;if(s===ua)return o.FLOAT;if(s===qa)return o.HALF_FLOAT;if(s===sv)return o.ALPHA;if(s===rv)return o.RGB;if(s===bi)return o.RGBA;if(s===Go)return o.DEPTH_COMPONENT;if(s===Vo)return o.DEPTH_STENCIL;if(s===ov)return o.RED;if(s===zd)return o.RED_INTEGER;if(s===lv)return o.RG;if(s===Id)return o.RG_INTEGER;if(s===Bd)return o.RGBA_INTEGER;if(s===Oc||s===Pc||s===zc||s===Ic)if(h===ze)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Oc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Pc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===zc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Ic)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Oc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Pc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===zc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Ic)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===td||s===ed||s===nd||s===id)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===td)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===ed)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===nd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===id)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ad||s===sd||s===rd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===ad||s===sd)return h===ze?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===rd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===od||s===ld||s===cd||s===ud||s===fd||s===hd||s===dd||s===pd||s===md||s===gd||s===_d||s===vd||s===Sd||s===xd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===od)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===ld)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===cd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===ud)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===fd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===hd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===dd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===pd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===md)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===gd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===_d)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===vd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Sd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===xd)return h===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===yd||s===Md||s===Ed)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===yd)return h===ze?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Md)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Ed)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Td||s===bd||s===Ad||s===Rd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Td)return c.COMPRESSED_RED_RGTC1_EXT;if(s===bd)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ad)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Rd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ho?o.UNSIGNED_INT_24_8:o[s]!==void 0?o[s]:null}return{convert:i}}const k1=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			`})}}function xA(){const o=An.useRef(null),[t,i]=An.useState(50),[s,l]=An.useState(45),[c,h]=An.useState(0),[d,m]=An.useState(0),[p,S]=An.useState(0),[_]=An.useState(Date.now()),[x,M]=An.useState(!1),E=An.useRef({w:!1,a:!1,s:!1,d:!1}),[w,y]=An.useState({x:0,y:0}),[g,N]=An.useState(!1),L=An.useRef([]),D=An.useRef(null);An.useEffect(()=>{const U=o.current,B=new Ky;B.background=new be(16777215);const A=new gi(75,U.clientWidth/U.clientHeight,.1,1e3);A.position.set(0,0,50);const R=new K1({antialias:!0});R.setSize(U.clientWidth,U.clientHeight),U.appendChild(R.domElement);const F=new _A(R),Y={normalEdgeStrength:2,depthEdgeStrength:1},$=new SA(2,B,A,Y);F.addPass($);const ct=new vA;F.addPass(ct);const rt=new J1(A,R.domElement);rt.enableDamping=!0;const P=new Io(20,9),j=new Cc({color:0,flatShading:!0,roughness:0,metalness:1}),q=new nM(P),_t=new Sv({color:3342336}),Et=new eM(q,_t);B.add(Et);const z=new Rn(P,j);B.add(z),P.attributes.position.array.slice();const it=new Bo(.3,4,4),Rt=new zo({color:4473924});for(let Nt=0;Nt<200;Nt++){const mt=new Rn(it,Rt),Ut=100+Math.random()*50,Mt=Math.random()*Math.PI*2,ut=Math.acos(2*Math.random()-1);mt.position.x=Ut*Math.sin(ut)*Math.cos(Mt),mt.position.y=Ut*Math.cos(ut),mt.position.z=Ut*Math.sin(ut)*Math.sin(Mt),B.add(mt)}const Ot=new uM(16777215,1);B.add(Ot);const zt=new cM(16777215,10,0);zt.position.set(0,0,25),B.add(zt);const at=new Io(1),ht=new Cc({color:65280}),Dt=new Rn(at,ht);Dt.position.set(0,0,21),B.add(Dt);const Gt=new Wd(.2,.2,3,3),Kt=new Cc({color:16776960}),le=new Rn(Gt,Kt);Dt.add(le);const Ke=(Nt,mt)=>{const Ut=Nt*Math.PI/180,Mt=mt*Math.PI/180,ut=Dt.position.clone().normalize();let xt=new W(0,1,0);Math.abs(ut.dot(xt))>.9&&(xt=new W(1,0,0));const Pt=new W().crossVectors(xt,ut).normalize(),Lt=new W().crossVectors(ut,Pt).normalize(),bt=new W;bt.add(ut.clone().multiplyScalar(Math.sin(Ut))),bt.add(Pt.clone().multiplyScalar(Math.cos(Ut)*Math.sin(Mt))),bt.add(Lt.clone().multiplyScalar(Math.cos(Ut)*Math.cos(Mt))),bt.normalize();const qt=Dt.worldToLocal(Dt.position.clone().add(bt)).normalize();le.position.copy(qt.clone().multiplyScalar(2)),le.quaternion.setFromUnitVectors(new W(0,1,0),qt)};o.current.updateIndicator=Ke,Ke(45,0);const V=()=>{const Nt=[],mt=new Cc({color:16711680});for(let Ut=0;Ut<12;Ut++){const Mt=Math.random()*Math.PI*2,ut=Math.acos(2*Math.random()-1),xt=new Io(1),Pt=new Rn(xt,mt),Lt=new W(21*Math.sin(ut)*Math.cos(Mt),21*Math.cos(ut),21*Math.sin(ut)*Math.sin(Mt));Pt.position.copy(Lt),Pt.lookAt(Lt.clone().multiplyScalar(2)),B.add(Pt),Nt.push(Pt)}return Nt},Me=V();L.current=Me,o.current.createTargets=V;let Vt=null,te=new W;const kt=[],we=Nt=>{const mt=Nt.clone().normalize(),Ut=P.attributes.position,Mt=new W;let ut=0,xt=0;const Pt=.2;for(let Lt=0;Lt<Ut.count;Lt++){Mt.fromBufferAttribute(Ut,Lt);const bt=Mt.clone().normalize(),qt=Math.acos(Math.max(-1,Math.min(1,mt.dot(bt))));if(qt<Pt){const k=1/(qt+.01);ut+=Mt.length()*k,xt+=k}}return xt>0?ut/xt:20},Wt=(Nt,mt=2)=>{const Ut=z.worldToLocal(Nt.clone()),Mt=P.attributes.position,ut=new W;for(let bt=0;bt<Mt.count;bt++){ut.fromBufferAttribute(Mt,bt);const qt=ut.distanceTo(Ut),k=8,Ct=k*.6;if(qt<k){const wt=ut.clone().normalize();if(qt<Ct){const Ft=1-qt/Ct,At=mt*Ft*Ft;ut.sub(wt.multiplyScalar(At))}else{const Ft=(qt-Ct)/(k-Ct),At=mt*.6*(1-Ft*Ft);ut.add(wt.multiplyScalar(At))}Mt.setXYZ(bt,ut.x,ut.y,ut.z)}}Mt.needsUpdate=!0,P.computeVertexNormals();const xt=Dt.position.clone().normalize(),Pt=we(xt)+1;Dt.position.copy(xt.multiplyScalar(Pt));const Lt=L.current;for(let bt=0;bt<Lt.length;bt++){const qt=Lt[bt].position.clone().normalize(),k=we(qt)+1;Lt[bt].position.copy(qt.multiplyScalar(k))}},se=(Nt,mt)=>{for(let Mt=0;Mt<30;Mt++){const ut=new Bo(.4,4,4),xt=new zo({color:mt?16711680:16777215}),Pt=new Rn(ut,xt);Pt.position.copy(Nt);const Lt=new W((Math.random()-.5)*2,(Math.random()-.5)*2,(Math.random()-.5)*2).normalize().multiplyScalar(Math.random()*3+1);B.add(Pt),kt.push({mesh:Pt,velocity:Lt,life:1})}},We=(Nt,mt)=>{Wt(Nt,mt?2.5:1.5),se(Nt,mt)},Ye=(Nt,mt,Ut)=>{Vt&&B.remove(Vt);const Mt=new Bo(.5,8,8),ut=new zo({color:16711680});Vt=new Rn(Mt,ut),Vt.position.copy(Dt.position),B.add(Vt);const xt=mt*Math.PI/180,Pt=Ut*Math.PI/180,Lt=Nt/100,bt=Dt.position.clone().normalize();let qt=new W(0,1,0);Math.abs(bt.dot(qt))>.9&&(qt=new W(1,0,0));const k=new W().crossVectors(qt,bt).normalize(),Ct=new W().crossVectors(bt,k).normalize(),wt=new W;wt.add(bt.clone().multiplyScalar(Math.sin(xt))),wt.add(k.clone().multiplyScalar(Math.cos(xt)*Math.sin(Pt))),wt.add(Ct.clone().multiplyScalar(Math.cos(xt)*Math.cos(Pt))),wt.normalize(),te.copy(wt.multiplyScalar(Lt))};o.current.launchProjectile=Ye;const O=E.current,T=Nt=>{const mt=Nt.key.toLowerCase();mt in O&&(O[mt]=!0)},J=Nt=>{const mt=Nt.key.toLowerCase();mt in O&&(O[mt]=!1)};window.addEventListener("keydown",T),window.addEventListener("keyup",J);const pt=()=>{const mt=Dt.position.clone().normalize();let Ut=Math.atan2(mt.x,mt.z),Mt=Math.acos(mt.y);O.w&&(Mt-=.005),O.s&&(Mt+=.005),O.a&&(Ut-=.005),O.d&&(Ut+=.005),Mt=Math.max(.01,Math.min(Math.PI-.01,Mt));const ut=new W(Math.sin(Mt)*Math.sin(Ut),Math.cos(Mt),Math.sin(Mt)*Math.cos(Ut)),xt=we(ut)+1;Dt.position.copy(ut.multiplyScalar(xt));const Pt=Dt.position.clone().normalize(),Lt=new W(0,1,0);let bt=Lt.clone().sub(Pt.clone().multiplyScalar(Lt.dot(Pt))).normalize();bt.length()<.01&&(bt=new W(0,0,1));const qt=new W().crossVectors(Pt,bt).normalize();bt=new W().crossVectors(qt,Pt).normalize();const k=new Je;k.makeBasis(qt,Pt,bt),Dt.quaternion.setFromRotationMatrix(k)},Tt=()=>{requestAnimationFrame(Tt);const Nt=Date.now()*.001,mt=25;zt.position.x=Math.cos(Nt/10)*mt,zt.position.z=Math.sin(Nt/10)*mt,zt.position.y=Math.sin(Nt/10*.05)*3,pt();for(let Ut=kt.length-1;Ut>=0;Ut--){const Mt=kt[Ut];Mt.mesh.position.add(Mt.velocity),Mt.velocity.multiplyScalar(.95),Mt.life-=.02,Mt.mesh.material.opacity=Mt.life,Mt.mesh.material.transparent=!0;const ut=Mt.life;Mt.mesh.scale.set(ut,ut,ut),Mt.life<=0&&(B.remove(Mt.mesh),Mt.mesh.geometry.dispose(),Mt.mesh.material.dispose(),kt.splice(Ut,1))}if(Vt){const Ut=Vt.position.clone().normalize().multiplyScalar(-.02);te.add(Ut),Vt.position.add(te);let Mt=!1;const ut=L.current;for(let xt=ut.length-1;xt>=0;xt--)if(Vt.position.distanceTo(ut[xt].position)<3){We(Vt.position,!0),B.remove(ut[xt]),ut.splice(xt,1),B.remove(Vt),Vt=null,Mt=!0,m(Pt=>Pt+1),ut.length===0&&M(!0);break}!Mt&&Vt&&Vt.position.length()<20.5&&(We(Vt.position,!1),B.remove(Vt),Vt=null),Vt&&Vt.position.length()>200&&(B.remove(Vt),Vt=null)}rt.update(),F.render()};Tt();const ft=()=>{A.aspect=U.clientWidth/U.clientHeight,A.updateProjectionMatrix(),R.setSize(U.clientWidth,U.clientHeight),F.setSize(U.clientWidth,U.clientHeight)};return window.addEventListener("resize",ft),()=>{window.removeEventListener("resize",ft),window.removeEventListener("keydown",T),window.removeEventListener("keyup",J),kt.forEach(Nt=>{B.remove(Nt.mesh),Nt.mesh.geometry.dispose(),Nt.mesh.material.dispose()}),U.removeChild(R.domElement)}},[]);const H=()=>{o.current&&o.current.launchProjectile&&(o.current.launchProjectile(t,s,c),S(U=>U+1))};An.useEffect(()=>{o.current&&o.current.updateIndicator&&o.current.updateIndicator(s,c)},[s,c]),An.useEffect(()=>{const U=D.current;if(!U)return;const B=F=>{F.preventDefault(),N(!0);const Y=F.touches[0],$=U.getBoundingClientRect(),ct=$.width/2,rt=$.height/2,P=Y.clientX-$.left-ct,j=Y.clientY-$.top-rt,q=Math.sqrt(P*P+j*j),_t=40,Et=q>_t?P/q*_t:P,z=q>_t?j/q*_t:j;y({x:Et,y:z}),E.current.w=z<-15,E.current.s=z>15,E.current.a=Et<-15,E.current.d=Et>15},A=F=>{F.preventDefault();const Y=F.touches[0],$=U.getBoundingClientRect(),ct=$.width/2,rt=$.height/2,P=Y.clientX-$.left-ct,j=Y.clientY-$.top-rt,q=Math.sqrt(P*P+j*j),_t=40,Et=q>_t?P/q*_t:P,z=q>_t?j/q*_t:j;y({x:Et,y:z}),E.current.w=z<-15,E.current.s=z>15,E.current.a=Et<-15,E.current.d=Et>15},R=F=>{F.preventDefault(),N(!1),y({x:0,y:0}),E.current.w=!1,E.current.s=!1,E.current.a=!1,E.current.d=!1};return U.addEventListener("touchstart",B,{passive:!1}),U.addEventListener("touchmove",A,{passive:!1}),U.addEventListener("touchend",R,{passive:!1}),()=>{U.removeEventListener("touchstart",B),U.removeEventListener("touchmove",A),U.removeEventListener("touchend",R)}},[]);const I=()=>{if(o.current&&o.current.createTargets){L.current.forEach(B=>{const A=o.current.children[0];A&&A.remove(B)});const U=o.current.createTargets();L.current=U,m(0),S(0),M(!1)}};return Xe.jsxs("div",{children:[Xe.jsx("div",{ref:o,style:{width:"100%",height:"100vh"}}),Xe.jsxs("div",{style:{position:"absolute",top:"0px",right:"0px",background:"rgba(0,0,0,0.5)",color:"white",padding:"10px",fontSize:"24px",fontWeight:"bold"},children:["Score: ",d*100]}),Xe.jsxs("div",{style:{position:"absolute",bottom:"0px",right:"0px",left:"0px",maxWidth:"60%",marginLeft:"auto",background:"rgba(0,0,0,0.5)",color:"white",padding:"10px"},children:[Xe.jsxs("div",{children:[Xe.jsxs("label",{children:["Velocity: ",t]}),Xe.jsx("input",{type:"range",min:"10",max:"100",value:t,onChange:U=>i(Number(U.target.value)),style:{width:"100%"}})]}),Xe.jsxs("div",{children:[Xe.jsxs("label",{children:["Angle: ",s]}),Xe.jsx("input",{type:"range",min:"0",max:"90",value:s,onChange:U=>l(Number(U.target.value)),style:{width:"100%"}})]}),Xe.jsxs("div",{children:[Xe.jsxs("label",{children:["Heading: ",c]}),Xe.jsx("input",{type:"range",min:"0",max:"359",value:c,onChange:U=>h(Number(U.target.value)),style:{width:"100%"}})]}),Xe.jsx("button",{onClick:H,style:{width:"100%",padding:"10px",marginTop:"10px"},children:"Launch"})]}),x&&Xe.jsxs("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",background:"rgba(0,0,0,0.9)",color:"white",padding:"40px",borderRadius:"10px",border:"3px solid white",textAlign:"center",zIndex:1e3},children:[Xe.jsx("h1",{style:{fontSize:"48px",margin:"0 0 20px 0"},children:"VICTORY!"}),Xe.jsxs("p",{style:{fontSize:"20px",margin:"0 0 10px 0"},children:["Kills: ",d," × 100 = ",d*100]}),Xe.jsxs("p",{style:{fontSize:"20px",margin:"0 0 10px 0"},children:["Shots: ",p," × -30 = ",p*-30]}),Xe.jsxs("p",{style:{fontSize:"20px",margin:"0 0 20px 0"},children:["Time: ",Math.floor((Date.now()-_)/1e3),"s × -1 = -",Math.floor((Date.now()-_)/1e3)]}),Xe.jsxs("p",{style:{fontSize:"28px",margin:"0 0 30px 0",fontWeight:"bold",borderTop:"2px solid white",paddingTop:"10px"},children:["Final Score: ",d*100-p*30-Math.floor((Date.now()-_)/1e3)]}),Xe.jsx("button",{onClick:I,style:{fontSize:"24px",padding:"15px 30px",background:"white",color:"black",border:"none",borderRadius:"5px",cursor:"pointer",fontWeight:"bold"},children:"PLAY AGAIN"})]}),Xe.jsxs("div",{ref:D,style:{position:"absolute",bottom:"0px",left:"0px",width:"120px",height:"120px"},onMouseDown:U=>{N(!0);const B=U.currentTarget.getBoundingClientRect(),A=B.width/2,R=B.height/2,F=U.clientX-B.left-A,Y=U.clientY-B.top-R,$=Math.sqrt(F*F+Y*Y),ct=40,rt=$>ct?F/$*ct:F,P=$>ct?Y/$*ct:Y;y({x:rt,y:P}),E.current.w=P<-15,E.current.s=P>15,E.current.a=rt<-15,E.current.d=rt>15},onMouseMove:U=>{if(!g)return;const B=U.currentTarget.getBoundingClientRect(),A=B.width/2,R=B.height/2,F=U.clientX-B.left-A,Y=U.clientY-B.top-R,$=Math.sqrt(F*F+Y*Y),ct=40,rt=$>ct?F/$*ct:F,P=$>ct?Y/$*ct:Y;y({x:rt,y:P}),E.current.w=P<-15,E.current.s=P>15,E.current.a=rt<-15,E.current.d=rt>15},onMouseUp:()=>{N(!1),y({x:0,y:0}),E.current.w=!1,E.current.s=!1,E.current.a=!1,E.current.d=!1},onMouseLeave:()=>{g&&(N(!1),y({x:0,y:0}),E.current.w=!1,E.current.s=!1,E.current.a=!1,E.current.d=!1)},children:[Xe.jsx("div",{style:{position:"absolute",width:"120px",height:"120px",borderRadius:"50%",background:"rgba(0,0,0,0.3)",border:"3px solid rgba(255,255,255,0.5)"}}),Xe.jsx("div",{style:{position:"absolute",width:"50px",height:"50px",borderRadius:"50%",background:"rgba(255,255,255,0.7)",border:"2px solid white",left:`${60+w.x-25}px`,top:`${60+w.y-25}px`,transition:g?"none":"all 0.2s ease-out",boxShadow:"0 2px 10px rgba(0,0,0,0.3)"}})]})]})}Vx.createRoot(document.getElementById("root")).render(Xe.jsx(An.StrictMode,{children:Xe.jsx(xA,{})}));
